...
const settings = {
  badge: { number: 1, text: 'get started in seconds' },
  title: 'Set Up in Minutes',
  description: 'Simply add the script to your site, choose from a variety of plugins, or go for the API backend integration. The plug-and-play analytics alternative.',
  card_1: {
    title: 'Effortless Setup',
    content: 'We offer plugins, libraries, and tutorials for the most popular CMSs, website builders, and programming languages to get you up and running in no time.',
    carousel_images: [
  ...
  card_2: {
    ...
    content: 'Migrating from other web analytics solutions? Import your data from Plausible, Fathom, or Google Analytics in just a few clicks.',
  },
  card_3: {
    title: 'No Cookie Banner',
    content: 'Say goodbye to consent banners: works without cookies and never stores your visitors personal identifiable information.',
  },
  card_4: {
    title: 'Privacy-Friendly by Design',
    content: 'Built from the ground up with privacy in mind and with an open-source core, offering uncompromising GDPR, CCPA, PECR, and Schrems II compliant data protection.',
...
export default function Features1() {
  return (
    <div id="features" className="space-y-6 sm:space-y-7 md:space-y-8 lg:space-y-10 mx-auto text-center">
      ...
      <SlideEffect>
        <h2 className="text-2xl md:text-4xl lg:text-header capitalize font-medium leading-none text-transparent bg-clip-text bg-linear-to-b from-black to-black/60">
          {settings.title}
        </h2>
      </SlideEffect>
